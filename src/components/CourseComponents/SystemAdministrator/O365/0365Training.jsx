...
import O365Hero from "./0365Hero";
import O365Curriculum from "./O365Curriculum";
import WhyO365 from "./whyO365";
...
const O365Training = () => {
  ...
  return (
    <>
      ...
      <O365Curriculum />
      <CommonBatchSchedule
        title="O365 Training Certification"
        selfPacedFeatures={selfPaced}
        onlineFeatures={onlineClass}
        batchDetails={batches}
        corporateDetails={corporate}
      />
      <CommonFAQ courseName="O365" />
      <ContactUsPage courseName="0365 Training Certification" />
      <Footer />
    </>
  );
};

export default O365Training;
